...
//#endif
    ...
    IMGUI_API void          RenderText(ImVec2 pos, const char* text, const char* text_end = NULL, bool hide_text_after_hash = true, ImGuiTextColorCallback color_callback = NULL, void* cb_context = NULL);
    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width, ImGuiTextColorCallback color_callback = NULL, void* cb_context = NULL);
    ...
    // Widgets
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0, ImGuiTextColorCallback color_callback = NULL, void* cb_context = NULL);
